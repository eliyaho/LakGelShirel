      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 md:pl-8">
            <h2 className="text-3xl font-semibold mb-4 text-gray-800">Shirel Malka אודות</h2>
            <p className="text-gray-600 mb-4">
              לק גל שלי שיראל נוסד מתוך אהבה לאמנות הציפורניים ותשוקה ליופי. המייסדת שלנו, שיראל, החלה את דרכה כמעצבת
