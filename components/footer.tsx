      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
            <h3 className="text-lg font-semibold mb-2">Shirel Malka</h3>
          ...
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
            ...
            <p className="text-sm text-gray-400 mb-2">רחוב אפריים שריר 27 דירה 10</p>
            <p className="text-sm text-gray-400 mb-2">נהריה, ישראל</p>
            <p className="text-sm text-gray-400 mb-2">טלפון: 0539342613</p>
            <p className="text-sm text-gray-400">אימייל: Shirelazulaynails@gmail.com</p>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-4 text-center text-sm text-gray-400">
          © {new Date().getFullYear()} Shirel Malka. כל הזכויות שמורות.
        </div>
      </div>
    </footer>
  )
